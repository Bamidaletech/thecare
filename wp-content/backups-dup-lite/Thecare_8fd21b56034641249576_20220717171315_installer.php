...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Thecare_8fd21b56034641249576_20220717171315_archive.zip';
	const ARCHIVE_SIZE		 = '34145762';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8fd21b5-17171315';
    const SECONDARY_PACKAGE_HASH = '86e96f6-17171315';
	const VERSION			 = '1.4.7';
